...
$i18n['{{about2}}'] = 'Lucha por el primer puesto en el ranking de especialidades culinarias de tu grupo.';
$i18n['{{about3}}'] = 'Recibe notificaciones en tu movil cuando un colega cocina un nuevo plato y comparte tus propios platos. Quien será el siguiente master chef?';
$i18n['{{downloads1}}'] = 'Descarga&nbsp;<b>Eat this one</b>, crea un grupo y invita a tus compañeros de trabajo o de clase.';
$i18n['{{contactsupport}}'] = 'Soporte y feedback';
$i18n['{{contactsupport1}}'] = 'Envianos un correo con tus preguntas, sugerencias o quejas; estaremos contentos de saber de ti aunque sea para quejarte.';
$i18n['{{aroundtheweb}}'] = 'En la red';
$i18n['{{opensource}}'] = 'Código abierto';
$i18n['{{technicalstack}}'] = 'Todo el software en el que está basado Eat this one, desde las aplicaciones de movil hasta el servidor es de código abierto y está disponible en nuestra <a href="http://github.com/eat-this-one" target="_blank">cuenta de github</a>.';
$i18n['{{androidmodal}}'] = 'La app aún no esta disponible para descargar desde Google Play, mientras tanto la puedes descargar desde <a href="http://eat-this-one.com/android.apk">aquí</a>.';
