...
$i18n['{{purpose}}'] = 'Disfruta de la hora de comer en el trabajo o en clase';
$i18n['{{shortdesc}}'] = 'Olvídate de pagar por comida basura, cocinar cada noche o llevarte cada día el mismo plato al trabajo o a classe.';
$i18n['{{previous}}'] = 'Anterior';
$i18n['{{next}}'] = 'Siguiente';
$i18n['{{firststep}}'] = 'Hasta los mejores chefs se cansan de comer lo mismo cada día';
$i18n['{{secondstep}}'] = 'Por eso les gusta compartir sus especialidades culinarias';
$i18n['{{thirdstep}}'] = 'Sus compañeros encantados, porque ya no tienen que cocinar para mañana';
$i18n['{{forthstep}}'] = 'Y todo es maravilloso (sobretodo porque otro día cocinará otro compañero)';
