...
$i18n['{{about}}'] = '¿De qué va?';
$i18n['{{downloads}}'] = 'Descargas';
$i18n['{{contact}}'] = 'Contacto';
$i18n['{{selectlang}}'] = 'Idioma';
$i18n['{{shortdesc}}'] = 'Comparte comida con tus compañeros de trabajo o clase.';
$i18n['{{subshortdesc}}'] = '¿Quién cocina hoy?';
$i18n['{{about1}}'] = 'Olvídate de pagar por comida basura, de cocinar a diario o llevarte la misma fiambrera al trabajo cada dia.';
$i18n['{{about2}}'] = 'Lucha por el primer puesto en el ranking de especialidades culinarias de tu grupo.';
$i18n['{{about3}}'] = 'Recibe notificaciones en tu móvil cuando un compañero cocina un nuevo plato y comparte los tuyos propios. ¿Quién será el siguiente master chef?';
$i18n['{{downloads1}}'] = 'Descarga&nbsp;<b>Eat this one</b>, crea un grupo e invita a tus compañeros de trabajo o clase.';
